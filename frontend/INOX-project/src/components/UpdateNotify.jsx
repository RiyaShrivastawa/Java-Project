...
const UpdateNotify = () => {
  ...
  const handleUpdate = async () => {
    ...
    try {
      const response = await axios.put(
        `http://localhost:8080/${updateData?.comp}/update`,
        updateData?.data,
        {
          headers: {
  ...
  return (
    updateNotify && (
      <div
        className="update-modal-backdrop-updatenotify"
        onClick={handleCancel}
      >
        <div
          className="update-modal-container-updatenotify"
        ...
        >
          ...
          <div className="update-modal-actions-updatenotify">
            <button
              className="btn-updatenotify update-cancel-btn-updatenotify"
              onClick={handleCancel}
            >
              Cancel
            </button>
            <button
              className="btn-updatenotify update-confirm-btn-updatenotify"
